...
- 🎓 **Master's in Data Science** at the University of Buenos Aires (UBA).
...
- **[📘 Timonel-AI-Agent](https://timonel-ai-agent.streamlit.app/)**: An intelligent RAG-based assistant designed to query nautical and cartography PDF documents using natural language. Built with LangChain and ChromaDB, it provides precise answers with direct citations from the source material.
...
![Anthropic Claude](https://img.shields.io/badge/Anthropic_Claude-D4A574?style=for-the-badge)
